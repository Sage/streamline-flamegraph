...
exports.collapse = function(_, options) {
	...
	var input = (options.input && options.input !== '-') ? ez.devices.file.binary.reader(options.input) : ez.devices.std.in();
	input = input.nodeTransform(require('zlib').createGunzip()).map(ez.transforms.convert.toString());
